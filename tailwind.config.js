  ...
  theme: {
    extend: {
      ...
      colors: {//text-color,....
        ...
        primary: {
          DEFAULT: '#166534', // green-800  – main brand color
          light:   '#16a34a', // green-600  – hover / lighter variant
          lighter: '#dcfce7', // green-100  – background tints
          dark:    '#14532d', // green-900  – deep dark variant
        },
        secondary: {
          DEFAULT: '#b45309', // amber-700  – accent / badges
          light:   '#d97706', // amber-600  – hover
          lighter: '#fef3c7', // amber-100  – background tints
          dark:    '#92400e', // amber-800  – deep dark
        },
        tertiary: {
          DEFAULT: '#065f46', // emerald-800 – supporting tone
        ...
        brand: {
          ...
          bg:      '#f0fdf4', // very light green page background
          surface: '#ffffff',
